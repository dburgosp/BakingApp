...
public class RecipesProvider extends ContentProvider {
    ...
    public static final int CODE_INGREDIENT = 102;
    public static final int CODE_INGREDIENT_WITH_ID = 103;
    public static final int CODE_STEP = 104;
    public static final int CODE_STEP_WITH_ID = 105;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // content://com.davidburgosprieto.android.bakingapp/recipe
        matcher.addURI(authority, RecipesContract.PATH_RECIPE, CODE_RECIPE);

        // content://com.davidburgosprieto.android.bakingapp/recipe/1
        matcher.addURI(authority, RecipesContract.PATH_RECIPE + "/#", CODE_RECIPE_WITH_ID);

        // content://com.davidburgosprieto.android.bakingapp/ingredient
        matcher.addURI(authority, RecipesContract.PATH_INGREDIENT, CODE_INGREDIENT);

        // content://com.davidburgosprieto.android.bakingapp/ingredient/1
        matcher.addURI(authority, RecipesContract.PATH_INGREDIENT + "/#", CODE_INGREDIENT_WITH_ID);

        // content://com.davidburgosprieto.android.bakingapp/step
        matcher.addURI(authority, RecipesContract.PATH_STEP, CODE_STEP);

        // content://com.davidburgosprieto.android.bakingapp/step/1
        matcher.addURI(authority, RecipesContract.PATH_STEP + "/#", CODE_STEP_WITH_ID);
    ...
    public int bulkInsert(@NonNull Uri uri, @NonNull ContentValues[] values) {
        ...
        if (match == CODE_INGREDIENT_WITH_ID || match == CODE_RECIPE_WITH_ID || match == CODE_STEP_WITH_ID)
            // Insert one element.
            return super.bulkInsert(uri, values);
        else {
            // Insert a lot of elements. First, get table name.
            String table;
            switch (match) {
                case CODE_RECIPE:
                    table = RecipesContract.RecipesEntry.TABLE_NAME;
                    break;

                case CODE_INGREDIENT:
                    table = RecipesContract.IngredientsEntry.TABLE_NAME;
                    break;

                case CODE_STEP:
                    table = RecipesContract.StepsEntry.TABLE_NAME;
                    break;
            ...
            // Second, insert all elements in table.
            db.beginTransaction();
            int rowsInserted = 0;
            try {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor cursor;
        String table, newSelection;
        int match = sUriMatcher.match(uri);
        switch (match) {
            case CODE_RECIPE:
            case CODE_RECIPE_WITH_ID:
                table = RecipesContract.RecipesEntry.TABLE_NAME;
                newSelection = RecipesContract.RecipesEntry.COLUMN_RECIPE_ID;
                break;

            case CODE_INGREDIENT:
            case CODE_INGREDIENT_WITH_ID:
                table = RecipesContract.IngredientsEntry.TABLE_NAME;
                newSelection = RecipesContract.IngredientsEntry._ID;
                break;

            case CODE_STEP:
            case CODE_STEP_WITH_ID:
                table = RecipesContract.StepsEntry.TABLE_NAME;
                newSelection = RecipesContract.StepsEntry._ID;
                break;
        ...
        if (match == CODE_INGREDIENT || match == CODE_RECIPE || match == CODE_STEP) {
    ...
    public String getType(@NonNull Uri uri) {
        throw new RuntimeException("We are not implementing getType in Baking App.");
    }

    @Override
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        throw new RuntimeException(
                "We are not implementing insert in Baking App. Use bulkInsert instead");
    }

    @Override
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        throw new RuntimeException("We are not implementing update in Baking App");
    }
