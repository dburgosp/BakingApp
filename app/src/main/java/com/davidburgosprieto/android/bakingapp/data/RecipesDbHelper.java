...
public class RecipesDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_RECIPES_TABLE =
                "CREATE TABLE " + RecipesEntry.TABLE_NAME + " (" +
                        ...
                        RecipesEntry.COLUMN_NAME + " STRING NOT NULL, " +
                        RecipesEntry.COLUMN_IMAGE + " STRING);";
        ...
        final String SQL_CREATE_STEPS_TABLE =
                "CREATE TABLE " + StepsEntry.TABLE_NAME + " (" +
                        ...
                        StepsEntry.COLUMN_DESCRIPTION + " STRING NOT NULL, " +
                        StepsEntry.COLUMN_THUMBNAIL_URL + " STRING, " +
                        StepsEntry.COLUMN_VIDEO_URL+ " STRING, " +
                        StepsEntry.COLUMN_SHORT_DESCRIPTION + " STRING NOT NULL);";
        ...
        final String SQL_CREATE_INGREDIENTS_TABLE =
                "CREATE TABLE " + IngredientsEntry.TABLE_NAME + " (" +
                        ...
                        IngredientsEntry.COLUMN_MEASURE + " STRING NOT NULL, " +
                        IngredientsEntry.COLUMN_INGREDIENT + " STRING NOT NULL);";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + StepsEntry.TABLE_NAME);
